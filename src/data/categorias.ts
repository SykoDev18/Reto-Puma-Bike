// FUENTE DE VERDAD de las categorías. Es el contrato con el sistema de
// cronometraje: claves, rangos y vueltas no se cambian sin el comité, porque
// cualquier cambio rompe la importación de registros.
// Ninguna categoría se escribe en el JSX; todo se lee de aquí.
...
export type RutaAsignada = 'infantil' | '40' | '80'

// REGLA DE NEGOCIO A CONFIRMAR CON EL COMITÉ.
// La tabla "cómo se compite" se arma con esto, no con texto en el JSX.
export const MAPA_RUTAS: Record<Grupo, RutaAsignada[]> = {
  Infantiles: ['infantil'],
  'Grupo Menor': ['40'],
  'Grupo Mayor': ['80', '40'],
}

export const NOMBRE_RUTA: Record<RutaAsignada, string> = {
  infantil: 'Circuito infantil por rodadas',
  '40': 'Ruta corta · 40 km',
  '80': 'Ruta larga · 80 km',
}

/** Orden de presentación de los grupos (de menor a mayor exigencia). */
export const ORDEN_GRUPOS: Grupo[] = ['Infantiles', 'Grupo Menor', 'Grupo Mayor']
